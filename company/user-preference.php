 ...
 <h1><small></small>
  ...
  <table id="example2" class="table table-bordered table-striped">
   ...
   <tr>
    ...
    <td><img src="../assets/candidate/<?php echo $row['pic']; ?>" alt="GHS" width="60px;" height="60px;"></td>
   ...
   <td><?php echo date('d/M/Y', strtotime($row['datetime'])); ?></td>
    <td>
      ...
      <button type="buttton" name="remove" class="btn btn-primary" onclick="return confirm('confirm to remove')">Active</button>
     </form></td>
   </tr>
  <?php }?>
