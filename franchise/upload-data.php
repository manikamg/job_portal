...
<div class="box-header with-border"><h3 class="box-title">Upload Data Manage</h3></div>
            <div class="box-body">
              <div class="box-group" id="accordion">
                <div class="col-md-6"> 
                  <?php echo '<b style=color:red>'.$error.'</b>'; ?>
        <form method="post" enctype="multipart/form-data">
      <input type="hidden" name="stfid" value="<?php echo $run['id'];  ?>">
     <div class="form-group has-feedback">
      <div class="form-group has-feedback">
        <label>Heading Name</label>
      <input type="text" name="heading" maxlength="45" class="form-control" placeholder="Enter Heading" required="required">
      ...
      <ul class="list-group">
  <li class="list-group-item" aria-current="true"><a href="data/calling_data_upload_formate.csv" target="_blank" style="color: red;"><small>Download Sample Upload csv. Formate</small></a></li>
</ul>
