...
?>
 ...
 <h1><small>New Job Applications</small></h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
       <div class="col-md-12">
            ...
            <div class="box-body">
              ...
              <td><button type="button" onclick="window.open('new-application-details?jid=<?php echo base64_encode($run['jobid']) ?>','_self')" class="btn btn-primary">View</button></td>
          </tr>
        <?php $i++;}?>
        </tbody>
        </table>    
