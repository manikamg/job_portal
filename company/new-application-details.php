...
//modal data insert
 ...
 //SELECT `id`, `admid`, `stfid`, `compid`, `jobid`, `applicantid`, `status`, `msg`, `stf_status`, `stf_comment`, `adm_status`, `adm_comment`, `final_status`, `job_status`, `job_comment`, `read_status`, `final_comment`, `final_date`, `timedate`, `ip` FROM `aplied_job` WHERE 1
       ...
       <div class="col-md-12">
            ...
            <div class="box-body">
              ...
              <td style="width: 60px;">
                ...
                <button type="button" class="btn btn-default statusid" data-toggle="modal" data-target="#modal-default" data-id="<?php echo $run['id']; ?>">
                Hold
              </button>
          <?php }?>
              </td>
