<?php 
 ...
 <h1><small><a href="dashboard?id=<?php echo trim($_GET['id']); ?>"><< Back</a>< Client Manage</small>
      </h1>
      <ol class="breadcrumb">
  ...
  <table id="example1" class="table table-fixedheader table-bordered table-striped">
   ...
   <tr>
    <td><?php echo $i; ?></td>
    <td><img src="consultancy.rmjob.in/assets/clients/<?php echo $rrr['pic']; ?>" alt="No Pic" width="60px;" height="60px;"></td>
    <td><b><?php echo $rrr['farmname']; ?></b><br/><?php echo $rrr['name']; ?></td>
    <td><?php echo $rrr['farmno']; ?></td>
    <td><?php echo $rrr['contact']; ?></td>
    <td><a href="#" class="btn btn-primary"><?php echo ucwords($rrr['status']); ?></a></td>
    <td><?php echo $rrr['loginid'] ?></td>
    <td><?php echo $rrr['pass'] ?></td>
    <td><form method="post" class="delete_form" action="#">
