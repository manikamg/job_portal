  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      <div class="box" style="border-color: purple">
        <div class="box-body table-resppnsive" style="overflow-x:auto; padding-right: 40px; ">
          <table id="manage_job" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>Sno</th>
                <th>P.Date</th>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($row['compid'] == '0') {
                      ...
                      echo ucwords(companyname($row['compid']));
                    } ?>
                  </td>
                  <td>
                  ...
                  <td>
                    <?php echo ucwords($row['post_number']) ?>
                  </td>
                  <td>
                    <?php echo date('d/m/Y', strtotime($row['timedate'])); ?>
                  </td>
                  <td>
                    <form method="post">
                      ...
                      <?php } else {
                        echo '<b style=color:green><i class="fa fa-circle text-success"></i> Live</b>';
                      } ?>
                    </form>
                  </td>
                  <td>
                    <form method="post">
                      ...
                      <?php } else { ?>
                        ...
                        <button name="chng" type="submit" class="btn btn-danger btn-flat"
                          style="font-size: 10px;"><small>Deactive</small></button>
                      <?php } ?>
                    </form>
                  </td>
                </tr>
