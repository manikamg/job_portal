...
<div class="content" style="background-color:#fff;">
    <section class="content-header">
        <h1><small><button type="button" onclick="window.open('./','_self');" class="btn btn-dark">Home</button></small>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <table class="table table-responsive">
                        <tr>
                            <th><a href="new-job-applications-manage?id=<?php echo trim($_GET['id']); ?>"
                                    ...
                                    Application</a></th>
                            <th><a href="candidate-manage?id=<?php echo trim($_GET['id']); ?>" class="btn btn-primary"
                                    style="width:300px;"><i class="fa fa-circle-o"></i> Candidate Manage</a> </th>
                        </tr>
                        <tr>
