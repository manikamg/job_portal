    ...
    <div class="row">
          ...
          <div class="box box-success box-solid">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" onclick="window.open('form-setting','_self')"
            ...
            <form method="post" action="#">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <select type="type" name="place" class="form-control" id="place">
                    <option value="<?php echo $row['field'] ?>">
                      <?php echo ucwords($row['field']); ?> Info
                    </option>
                ...
                <div class="form-group">
                  ...
                  <input type="type" name="formname" value="<?php echo ($row['name']); ?>" class="form-control"
                    id="formname" placeholder="Form Heading" required="required">
                </div>
                <div class="form-group">
          ...
          <?php } else { ?>
            <form method="post" action="#">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Field Name</label>
                  <input type="type" name="formname" class="form-control" id="formname" placeholder="Form Heading"
                    required="required">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Field Type</label>
      ...
      <div class="col-md-6">
        <!-- @if($message = Session::get('delete'))
            ...
            @endif -->
        <div class="box box-primary" style="padding: 0px 10px;">
          <div class="box-header with-border">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php } elseif ($row['field'] == 'family') { ?>
                      <span class="label label-right bg-green">
                        <?php echo $row['type']; ?>
                      </span>
                  ...
                  <td><a href="form-setting?id=<?php echo $row['id']; ?>" class="btn btn-warning"><i
