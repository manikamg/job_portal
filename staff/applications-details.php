<?php 
  ...
  $sqlcan=mysqli_query($db,"SELECT * FROM `candidate` WHERE `id`='".base64_decode(trim($_GET['id']))."'");
  $runcan=mysqli_fetch_array($sqlcan);
  //get post details
  //get other details
  ...
  $interview=mysqli_query($db,"INSERT INTO `interview`(`clientid`, `candidateid`, `postid`, `ip`) VALUES ('".$run['id']."','".$runcan['id']."','".$jobid."','".$_SERVER['REMOTE_ADDR']."'")or die(mysqli_error($db));
...
$postl=mysqli_fetch_array($sqlp); -->
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
                 <?php if(empty($runcan['pic'])){ ?>
             <img class="profile-user-img img-responsive img-circle" src="../assets/general/jobs.png" alt="<?php echo $runcan['name']; ?>">  
           <?php }else{?>
          <img class="profile-user-img img-responsive img-circle" src="../assets/candidate/<?php echo $runcan['pic']; ?>" alt="<?php echo $runcan['name']; ?>">   
          <?php }?> 	
            </div>
          </div>
          <div class="box box-primary">
            <div class="box-body box-profile">
               <?php if(!empty($runcan['resume'])){ ?>
             <a href="../assets/candidate/<?php echo $runcan['resume']; ?>">
             	<img class="profile-user-img img-responsive img-circle" src="../assets/general/download.png" alt="<?php echo $runcan['resume']; ?>"/></a> 
         ...
         <div class="box box-warning box-solid">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
               <button type="button" class="btn btn-box-tool" onclick="window.open('applications-details?pid=<?php echo $_GET['pid'] ?>&id=<?php echo $_GET['id'] ?>','_self')" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
          </div></div>
                <?php } ?>
    ...
    <?php }?>
          ...
          <div class="box box-default box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Selection(For Interview)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
