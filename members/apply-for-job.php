...
?>
  <div class="content-wrapper">
    <section class="content-header">
      <h1><small><a href="./?main"><< Back</a></small></h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
        ...
        if(isset($_GET['success'])){ ?>
                <div class="col-md-2 col-xs-12"></div>  <div class="col-md-4 col-xs-12">
         <div class="box box-success box-solid">
            <div class="box-header with-border">
              <div align="center"><h3 class="box-title">Apply For Job Is <br/> Successfully</h3></div>
             <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" onclick="window.open('apply-for-job?id=<?php echo $_GET['id']; ?>','_self')" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
          </div></div></div>
                <?php } ?>
                 <?php
        if(isset($_GET['already'])){ ?>
         ...
         <div class="box box-danger box-solid">
            <div class="box-header with-border">
              <div align="center"><h3 class="box-title">You are Already Applied For This Post<br/><br/> On - 
                <?php echo date('d/m/Y',strtotime(base64_decode(trim($_GET['adate'])))); ?></h3></div>
           ...
           <div class="box box-widget widget-user-2">
            <div class="widget-user-header bg-yellow">
              <div class="widget-user-image">
                <img class="img-circle" src="../assets/general/jobs.png" alt="<?php echo ucwords($runpost['postname']); ?>" style="height:50px;">
              </div>
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username"><?php echo strtoupper($runpost['postname']); ?></h3>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#"><i class="fa fa-ship fa-1x" style="color:#000;"></i> POST NAME 
                  <span class="pull-right badge bg-blue"><?php echo ucwords($runpost['postname']); ?></span></a></li>
                <li><a href="#"><i class="fa fa-ship fa-1x" style="color:#000;"></i> NUMBER OF POST 
                  <span class="pull-right badge bg-aqua"><?php echo ucwords($runpost['post_number']); ?></span></a></li>
                <li><a href="#"><i class="fa fa-ship fa-1x" style="color:#000;"></i> SELECTION PROCESS
                  <span class="pull-right badge bg-green"><?php echo ucwords($runpost['joiningprocess']); ?></span></a></li>
                <li><a href="#"><i class="fa fa-ship fa-1x" style="color:#000;"></i> QUALIFICATION <span class="pull-right badge bg-red"><?php echo ucwords($runpost['highestqualification']); ?></span></a></li>
                <li><a href="#"><i class="fa fa-ship fa-1x" style="color:#000;"></i> SALARY RANGE 
                  <span class="pull-right badge bg-red"><?php echo '&#8377; :'.($runpost['ssalary']).'&nbsp; to &nbsp;&#8377; : '.($runpost['esalary']); ?></span></a></li>
              </ul>
            </div>
            <div class="box-header">
             ...
             <div class="box-header">
              ...
              <ul>
               <li><i class="fa fa-circle-o text-aqua"></i> Company Name: <b><?php if(!empty($compd['farmname'])){ echo ucwords($compd['farmname']); }else{ echo 'Not Available';} ?></b></li>
               <li><i class="fa fa-circle-o text-aqua"></i> Contact Person Name: <b>
                <?php if(!empty($compd['name'])){ echo ucwords($compd['name']); }else{ echo 'Not Available';} ?></b></li>
               <li><i class="fa fa-circle-o text-aqua"></i> Contact Person MOB: <b>
                <?php if(!empty($compd['contact'])){ echo ucwords($compd['contact']); }else{ echo 'Not Available';} ?></b></li>
               <li> <i class="fa fa-circle-o text-aqua"></i> Company RNo: <b>
                <?php if(!empty($compd['farmno'])){ echo ucwords($compd['farmno']); }else{ echo 'Not Available';} ?></li>
             </ul>
             <label>Profile</label>
             <div align="justify">
               <?php if(!empty($compd['other'])){ echo ucwords($compd['other']); }else{ echo 'Not Available';} ?>
             </div>
            </div>
            <hr/> 
            <label>Message</label>
      ...
      <li><a href="#"><i class="fa fa-ship fa-1x" style="color:#000;"></i> <?php echo strtoupper($runpost['postname']); ?>
      <span class="pull-right badge bg-red">&#8377; : <?php echo ($runpost['ssalary']).'&nbsp; - &nbsp;&#8377; : '.($runpost['esalary']); ?></span></a>
      <br/><br/><br/>
      <a href="apply-for-job?id=<?php echo base64_encode($runpost['id']); ?>"><span class="pull-center badge bg-blue"><< View</span></a>
      <span class="pull-right badge bg-green"><?php echo ucwords($runpost['joiningprocess']); ?></span></li>
      <br/></div>
       <?php }}else{
          echo '<li>0</li>';
       }?> 
