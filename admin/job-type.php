          ...
          <div class="box box-success box-solid">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" onclick="window.open('job-type','_self')"
            ...
            <form method="post" action="#">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="type" name="name" class="form-control" value="<?php echo $rowx['name']; ?>" id="formname"
                    placeholder="Form Heading" required="required">
                </div>
              </div>
              ...
              <div align="center">
                <div class="box-footer">
                  ...
                  <button type="button" onclick="window.open('job-type','_self');"
          ...
          <?php } else { ?>
            <form method="post" action="#">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Name</label>
                  <input type="type" name="name" class="form-control" id="formname" placeholder="Enter Type"
                    required="required">
                </div>
              </div>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_array($sql)) { ?>
                <tr>
                  ...
                  <td><a href="job-type?id=<?php echo $row['id']; ?>" class="btn btn-warning"><i
