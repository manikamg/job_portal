 ...
 <h1><small></small>
        ...
        <div class="box box-warning">
            <div class="box-header with-border"> 
              ...
              <div class="box-tools pull-right">
                <button onclick="window.open('employee-add','_self');" type="button" class="btn btn-primary" data-widget="collapse">Add New
                </button>
              </div>
              <!-- /.box-tools -->
            </div>
  ...
  <table id="example1" class="table table-fixedheader table-bordered table-striped">
   ...
   <tr>
    ...
    <td><img src="../assets/employee/<?php echo $row['pic']; ?>" alt="GHS" width="60px;" height="60px;"></td>
    <td><b><?php echo $row['name']; ?></b></td>
    <td><b><?php echo $row['post']; ?></b></td>
    ...
    <td>
      <a href="employee-edit?id=<?php echo $row['id'];?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
    </td> 
     <td>
