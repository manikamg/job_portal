...
$psql=mysqli_query($con,"UPDATE `candidate` SET `name`='$nameone',`middle`='$nametwo',`last`='$namethree',`contact`='$call',`emailid`='$mail',`hq`='$qaulification' WHERE `id`='$cid'")or die(mysqli_error($db));
         ...
         <div class="box box-denger box-solid">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" onclick="window.open('update-profile','_self')" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
          </div></div>
                <?php } ?>
          ...
          <?php }?> 
            ...
            <br/>
            <button type="submit" name="submit" class="btn btn-primary btn-block"><b>UPDATE</b></a>
            </div>
            </form>
          </div>
           <?php
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <form enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>#">
                ...
                <a href="../assets/candidate/<?php echo $run['resume']; ?>" target="_blank"><img class="profile-user-img img-responsive img-circle" name="resume" src="../assets/general/download.png" alt="focusmedia.co.in"></a>
         ...
         <div class="col-xs-12 col-sm-6 col-md-4">
          <div class="form-group">
            ...
            <select name="hq"  class="form-control">
                <?php if(!empty($run['hq'])){ ?><option value="<?php echo $run['hq'] ?>"><?php echo $run['hq'] ?></option><?php }?>
