<?php 
  ...
  //farm name
  $comp=mysqli_query($db,"SELECT * FROM `client` WHERE `id`='".(trim($runpost['compid']))."'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
           ...
           <div class="box box-widget widget-user-2">
            ...
            <div class="box-header">
             ...
             <div class="box-header">
              ...
              <ul>
               <li><i class="fa fa-circle-o text-aqua"></i> Company Name: <b><?php echo ucwords($compd['farmname']); ?></b></li>
               <li> <i class="fa fa-circle-o text-aqua"></i> Company RNo: <b><?php echo ucwords($compd['farmno']); ?></li>
             </ul>
             <label>Profile</label>
             <div align="justify">
               <?php echo ucwords($compd['about']); ?>
             </div>
            </div>
            <hr/> 
            <label>Message</label>
       ...
       <h4>Similar Jobs</h4>
      <?php 
      $postz=mysqli_query($db,"SELECT * FROM `post_job` WHERE `status`='active' AND `stf_approve`='approved' AND `id`!='".base64_decode(trim($_GET['id']))."");
