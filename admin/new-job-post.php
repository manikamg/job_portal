...
<div class="content-wrapper">
  ...
  <a
    href="new-job-step?<?php echo (md5(uniqid())); ?>&type=<?php echo trim($_GET['type']); ?>&name=<?php echo trim($_GET['typen']); ?>&tag=<?php echo trim($_GET['tag']); ?>&tagn=<?php echo trim($_GET['tagn']); ?>">
    << Back</a>
      <div class="row">
            ...
            <?php if (isset($_GET['success'])) { ?>
              <div class="box box-warning box-solid">
                <div class="box-header with-border">
                  <div align="center">
                    <h3 class="box-title">Job Posted <br /><br /> Successfully</h3>
                  </div>
                  <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool"
                      onclick="window.open('new-job-post?<?php echo md5(uniqid()); ?>&type=<?php echo trim($_GET['type']); ?>&typen=<?php echo trim($_GET['typen']); ?>&tag=<?php echo trim($_GET['tag']); ?>&tagn=<?php echo trim($_GET['tagn']); ?>','_self')"
            ...
            >
              ...
              <div class="box-body">
                <div class="form-group">
                  <div align="right"><label>Job Code</label> : <input type="text" name="pcode"
                      value="<?php echo mt_rand(); ?>" maxlength="10" required="required"></div>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select class="form-control" name="jtyp" style="width:100%;">
                        <option value="<?php echo base64_decode(trim($_GET['type'])); ?>">
                          <?php echo base64_decode(trim($_GET['typen'])); ?>
                        </option>
                      </select>
                      <div class="input-group-addon">
                      ...
                      <select class="form-control" name="jtag">
                        <option value="<?php echo base64_decode(trim($_GET['tag'])); ?>">
                          <?php echo base64_decode(trim($_GET['tagn'])); ?>
                        </option>
                      </select>
                      </span>
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" name="company">
                        ...
                        <?php while ($abc = mysqli_fetch_array($npost)) { ?>
                          <option value="<?php echo $abc['id']; ?>">
                            <?php echo ucwords($abc['name']) . '&nbsp;-&nbsp;' . ucwords($abc['farmname']); ?>
                          </option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="Post Name" maxlength="95" class="form-control" name="postname"
                        required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="Number of Post" maxlength="10" pattern="[0-9]+"
                        class="form-control" name="number_post" required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" maxlength="65" placeholder="Priority" class="form-control" name="priority"
                        required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="Computer Operatior," maxlength="25" class="form-control"
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="Raipur,Durg,Mumbai,Wizag,Delhi" maxlength="125"
                        class="form-control" name="location" required="required">
                    </div>
                  </div>
                  <div class="form-group">
                    <label>Gender</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" placeholder="From" pattern="[0-9]+" name="startsalary" required="required"> -
                      <input type="text" placeholder="To" name="endsalary" pattern="[0-9]+">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="date" value="<?php echo date('Y-m-d'); ?>" class="form-control" name="openingdate"
                        required="required">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" pattern="[0-9]+" placeholder="Alternative Number" class="form-control"
