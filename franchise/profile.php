...
$qualification=mysqli_real_escape_string($db,$_POST['hq']);
$psql=mysqli_query($db,"UPDATE `candidate` SET `name`='$nameone',`middle`='$nametwo',`last`='$namethree',`contact`='$call',`emailid`='$mail',`hq`='$qualification' WHERE `id`='$cid'");
...
?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         <small style="color:black;"><a href="./?main"><< Back</a></small> 
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-3">
         ...
         <div class="box box-denger box-solid">
            <div class="box-header with-border">
              <div align="center"><h3 class="box-title">Image Uploaded <br/> Successfully</h3></div>

              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" onclick="window.open('profile','_self')" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
          </div></div>
                <?php } ?>
          ...
          <?php }?> 
            ...
            <br/>
            <button type="submit" name="submit" class="btn btn-primary btn-block"><b>Add</b></a>
            </div>
            </form>
          </div>
          <?php
         ...
         <div class="box box-denger box-solid">
          ...
          <div class="box box-primary">
            ...
            <br/>
            <button type="submit" name="submit_resume" class="btn btn-primary btn-block"><b>Add</b></a>
            </div>
            </form>
          </div>
          </div>
         ...
         <div class="box box-warning box-solid">
            <div class="box-header with-border">
              <div align="center"><h3 class="box-title" style="text-align: center;">Profile Added <br/>Success</h3>
...
<div class="box">
      ...
      <div class="row">
         ...
         <div class="col-xs-12 col-sm-6 col-md-4">
          <div class="form-group"> 
            ...
            <select name="hq"  class="form-control">
              <?php if(isset($run['hq'])){ ?>
              <option value="<?php echo $run['hq'] ?>"><?php echo strtoupper($run['hq']); ?></option>
              <?php }?>
              ...
              <option value="b.e">B.E/B.Tech/BCA</option>
              <option value="m.e">M.E/M.Tech/MCA</option>
              <option value="mba">MBA</option>
              <option value="m.s">Master Degree</option>
         ...
         <div class="col-xs-12 col-sm-6 col-md-4">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo ucwords($run['field']); ?></h3>
              <div class="box-tools pull-right">
               <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button></div>
            </div>
            ...
            $fieldtype=$arr[0]; // will print Test
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<label><?php echo ucwords($value['name']); ?></label>
						...
						<input type="hidden" name="fieldname[]" value="<?php echo strtolower(str_replace(' ', '', $value['name'])); ?>">
						<?php if($value['type']=='normal'){?>
						<input type="<?php if($fieldtype=='contact'){ echo 'number';}elseif($fieldtype=='email'){ echo 'email';}elseif($fieldtype=='date'){ echo 'date';}else{ echo 'text';} ?>" name="value[]" id="password" class="form-control" placeholder="<?php echo ucwords($value['name']); ?>" tabindex="5">
					<?php }else{?>
						<textarea  name="value[]" id="password" class="form-control" placeholder="<?php echo ucwords($value['name']); ?>"></textarea>
					<?php }?>
					</div>
				</div>
			<?php }?>
		...
		<?php }?>
			...
			<div class="row">
				<div class="col-xs-12">
				<div align="center">	
					<button type="submit" style="width: 20%" name="submit_data" class="btn btn-success btn-block">Submit</button></div>
				</div>
			</div>
		</form>
          </div>
