<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php date('Y') ?>  
       <a href="https://focusmedoa.co.in">FocusMedia</a>. 
    </strong> All rights
    reserved.
  </footer>
...
<script src="../dist/js/demo.js"></script><script src="../bower_components/jquery/dist/jquery.min.js"></script><script src="../bower_components/jquery-ui/jquery-ui.min.js"></script><script> 
