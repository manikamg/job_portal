  ...
  <div class="container" style="padding-right:50px;">
    <section class="content-header">
      <h1><small><a href="dashboard?id=<?php echo trim($_GET['id']); ?>">
            << Back</a> candidate manage </small> </h1>
      <ol class="breadcrumb">
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="label label-danger">
                          <?php echo jobtyCountAppliedJob($row['id']) ?></a>
                        </span>
                      </td>
                      <td>
                        ...
                        <?php } else { ?>
                          <img src="../assets/candidate/<?php echo $row['pic']; ?>" alt="Job Portal" width="60px;"
                            height="60px;">
                        <?php } ?>
                      </td>
                      <td>
                        <b>
                          <?php echo $row['name'] . '&nbsp;' . $row['middle'] . '&nbsp;' . $row['last']; ?>
                        </b>
                      </td>
                      <td>
                        <?php echo $row['contact'] . '<br/>' . $row['emailid']; ?>
                      </td>
                      <td>
                        <?php echo date('d/m/Y', strtotime($row['datetime'])); ?>
                      </td>
                      <td>
                        <?php echo 'Username: ' . $row['contact'] . '<br/>Password:' . $row['pass']; ?>
                      </td>
                      <td>
                        <?php if (!empty($row['resume'])) { ?>
                          <a href="../assets/candidate/<?php echo $row['resume']; ?>" target="_blank"><img name="pic"
                              src="../assets/general/download.png" width="30px;" height="30px;"></a>
                        <?php } else {
                          echo 'Not Available';
                        } ?>
                      </td>
