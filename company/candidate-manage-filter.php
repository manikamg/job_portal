 ...
 error_reporting(0);
 if(isset($_GET['job'])){
  $sql=mysqli_query($db,"SELECT * FROM `candidate` WHERE `jobtyp`='".trim($_GET['job'])."'");
 ...
 <h1><?php echo ucwords($_GET['job']); ?></h1>
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li><a href="#">candidate <?php echo ucwords($_GET['job']); ?></a></li>
      </ol>
    </section>
    <div class="row">
       <div class="col-md-12 col-xs-12">
        <div class="box box-warning">
            <div class="box-header with-border"> 
              <h3 class="box-title">Candidate<small> Manage</small> <?php echo ucwords($_GET['job']); ?></h3>
              <div class="box-tools pull-right">
                <button onclick="window.open('candidate-add','_self');" type="button" class="btn btn-primary" data-widget="collapse">Add New
                </button>
              </div>
            </div>
            <div class="box-body">
  ...
  <table id="example1" class="table table-bordered table-striped">
   ...
   <tr>
    ...
    <?php }?>
      ...
      <td>
      <a href="full-profile?id=<?php echo base64_encode($row['id']); ?>" class="btn btn-primary"><i class="fa fa-user-o"></i></a>
    </td>
    <td>
     <?php if(empty($row['pic'])){ ?>
      <img src="../assets/general/1.png" alt="GHS" width="60px;" height="60px;">
    <?php }else{?>
      <img src="../assets/candidate/<?php echo $row['pic']; ?>" alt="GHS" width="60px;" height="60px;">
    <?php }?>
    </td>
    ...
    <td>
      ...
      <a href="../assets/candidate/<?php echo $row['resume']; ?>" target="_blank"><img  name="pic" src="../assets/general/download.png" width="30px;" height="30px;"></a>
